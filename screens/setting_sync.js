    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View>
                ...
                <TextBtn text={'Change email address'} onPress={() => { }}></TextBtn>
                <TextBtn text={'Change phone number'} onPress={() => { }}></TextBtn>
                <TextBtn text={'Change password'} onPress={() => { }}></TextBtn>
                <TextBtn text={'Delete Account'} onPress={() => { }}></TextBtn>
                <TextBtn text={'Log out'} onPress={() => { }} style={{ color: "red" }}></TextBtn>
            </View>
        </SafeAreaView>
    )
}
