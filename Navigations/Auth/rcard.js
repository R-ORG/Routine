...
const RCard = (props) => {
  ...
  return (
    <View>
      ...
      <Modal transparent={true} visible={detail}>
        <RPopup
          name={props.name}
          current={props.current ? props.current : 0}
          total={props.total}
          state={props.state}
          ftime={props.ftime ? props.ftime : 0}
          avgdone={props.avgdone ? props.avgdone : 0}
          lstreak={props.lstreak ? props.lstreak : 0}
          cstreak={props.cstreak ? props.cstreak : 0}
          color_1={color_1}
          color_2={color_2}
          color_3={color_3}
          setDetail={setDetail}
