...
function NewItem(props) {
    return (
        <TouchableHighlight onPress={() => {return (null);}} underlayColor='#0359e3'>
            <View style={styles.outItem}>
                ...
                >
                    ...
                    <View style={{flex: 1, flexWrap: 'nowrap', justifyContent: 'center', alignItems: 'center', overflow: 'visible'}}>
                        <ImageBackground
                        ...
                        >
                            <Image 
                            source={props.image}
                            style={{width: windowWidth * 0.2 * 0.9, height: windowHeight * 0.1}}
                            />
                        </ImageBackground>
                    </View>
                </LinearGradient>
    ...
    return (
        <View style={styles.container}>
            ...
            <FlatList
                ...
                renderItem={({item}) => <NewItem top={item.top} down={item.down} image={item.image}/>}
                ListFooterComponent={() => {
                    return (
                    isLoading ? 
                        <View style={{
